                        ...
                        <tbody>
                            <tr v-for="(data, index) in mapData" :key="data.id">
                                ...
                                <td
                                    ...
                                    v-if="u !== '0'"
                                >
                                    <div v-if="i != 'selectParentCategory'">
                                        {{
                                            i == "id"
    ...
    methods: {
        handlePageChange(page) {
            ...
            if (this.filterQuery) {
                axios
                    .get(
                        `${config.apiUrl}/api/product-category-form?page=${this.pagination.current_page}&search=${this.filterQuery}`,
                        {
                            headers: {
                ...
                axios
                    .get(
                        `${config.apiUrl}/api/product-category-form?page=${this.pagination.current_page}`,
                        {
                            headers: {
                                Authorization: `Bearer ${token}`,
                            },
        ...
        addLead() {
            this.$router.replace("/create-category-form");
        },
        EditForm(data) {
            this.$router.replace(`/create-category-form/${data}`);
        },
        DeleteForm(data) {
            ...
            if (confirm("Do you really want to delete?")) {
                axios
                    .delete(
                        `${config.apiUrl}/api/product-category-form/${data}`,
                        {
                            headers: {
                                Authorization: `Bearer ${token}`,
                            },
        ...
        getFormFieldsList() {
            ...
            let promise = axios.get(
                config.apiUrl + "/api/product-category-form",
                {
                    headers: {
        ...
        filter() {
            ...
            if (this.filterQuery.length > 0) {
                axios
                    .get(
                        `${config.apiUrl}/api/product-category-form?search=${this.filterQuery}`,
                        {
                            headers: {
                                Authorization: `Bearer ${token}`,
                            },
                ...
                axios
                    .get(`${config.apiUrl}/api/product-category-form`, {
                        headers: {
                            Authorization: `Bearer ${token}`,
                        },
                    })
